...
const {transform} = require('./rabbit-util');
...
{const
  ...
  log('start');
  bundle = transform(bundle, options);var _bundle =
  bundle;const startupModules = _bundle.startupModules,lazyModules = _bundle.lazyModules;
  log('finish');
